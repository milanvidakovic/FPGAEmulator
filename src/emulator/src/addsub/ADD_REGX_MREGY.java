...
public class ADD_REGX_MREGY extends Instruction {
	public ADD_REGX_MREGY(short[] memory, int addr, int src, int dest) {
		super(memory, addr, src, dest);
		super.setAssembler("add " + this.sdest + ", [" + this.ssrc + "]");
	}
