...
public class DIV_REGX_MREGY extends Instruction {
	public DIV_REGX_MREGY(short[] memory, int addr, int src, int dest) {
	...
	public void exec(Context ctx) {
		...
		int rem = ctx.getReg(this.dest).val % ctx.memory[fix(ctx.getReg(this.src).val)];
