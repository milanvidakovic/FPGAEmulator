...
public class SHR_REGX_MREGY_XX extends Instruction {
	public SHR_REGX_MREGY_XX(short[] memory, int addr, int src, int dest) {
		super(memory, addr, src, dest);
		super.setArgument();
		super.setAssembler("shr " + this.sdest + ", [" + this.ssrc +" + 0x%04x]");
	}
